package arrays;
/*
Problem description: There is a robot starting at position (0, 0), the origin, on a 2D plane. Given a sequence of its moves,
...
public class RobotReturnToOrigin {
        ...
        private static boolean judgeRobot(String steps) {
            int UD = 0;
            int LR = 0;
            for (int i = 0; i < steps.length(); i++) {
                char currentMove = steps.charAt(i);
                if (currentMove == 'U'){
                    UD++;

...
/*
Problem description: Given an array of meeting time intervals consisting of start and end times [[s1,e1],[s2,e2],...] (s[i] is strictly less than e[i]), determine if a person could attend all meetings.
...
Output: true
 */
public class MeetingRoomActivities {
